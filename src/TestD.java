...
public class TestD {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //参数变化值列表
        int[] DList = {10, 12, 14, 16, 18, 20};
        double[] AlpahList = {45, 55, 65, 80, 90, 105};
        //存放所有结果
        double[][][] res = new double[t][6][DList.length];
        ...
        for(int k = 0; k < DList.length; k++){
            ...
            //输出结果到控制台
            {
                System.out.println(type + " = " + DList[k]);
