...
public class TestM {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //参数变化值列表
        int addNum = 100;
        int[] SList = {100, 200, 300, 400, 500, 600};
        //存放所有结果
        double[][][] res = new double[t][6][SList.length];
        long[][][] runTime = new long[t][6][SList.length];
        for(int i = 0; i < t; i++){
            //初始化网络
            Algorithm.init(0, 800, 6);
            for(int j = 0; j < SList.length; j++){
                long start = 0;
                long end = 0;
                Algorithm.add(addNum, 0);
                System.out.println("M = " + SList[j] + "-----------------------");
        ...
        FileWriter fw = new FileWriter("C:\\Users\\HP\\Desktop\\data\\extend\\M.txt");
        BufferedWriter bf = new BufferedWriter(fw);
        FileWriter fw1 = new FileWriter("C:\\Users\\HP\\Desktop\\data\\extend\\runTime_M.txt");
